...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBHelper.getInstance().initDbHelp(this, 10086);
...
//                        .setAction("Action", null).show();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new PasswordNormalListFragment(), "Category 1");
        adapter.addFragment(new PasswordNormalListFragment(), "Category 2");
        adapter.addFragment(new PasswordNormalListFragment(), "Category 3");
